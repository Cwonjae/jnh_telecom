                        ...
                        <div class="table-responsive p-0" style="width:92%; margin:auto; margin-top:30px;">
                            ...
                            @csrf
                                <div class="flex flex-col mb-3">
                                    ...
                                    <input type="text" name="applicant" class="form-control" placeholder="Your Full Name" aria-label="Name" value="{{ $cell_phones->cpb_applicant }}" id="applicant">
                                    @error('applicant') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <h6>Nationality <span style="color:red">*</span></h6>
                                    <input type="text" name="nationality" class="form-control" placeholder="Nationality" aria-label="Nationality" value="{{ $cell_phones->cpb_nationality }}" autocomplete="off" id="inputSearch">
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <input type="text" name="dateofbirth" class="form-control" placeholder="MM-DD-YYYY" aria-label="Date Of Birth" value="{{ $cell_phones->cpb_dateofbirth }}" id="dateofbirth" maxlength="11">
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="gender" id="flexRadioDefault_m" value="male" @if($cell_phones->cpb_gender == "male") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_m">Male</label>
                                    <input class="form-radio-input" type="radio" name="gender" id="flexRadioDefault_f" value="female" @if($cell_phones->cpb_gender == "female") checked @else @endif>
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="device" id="flexRadioDefault_ap" value="apple" @if($cell_phones->cpb_device == "apple") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_ap">Apple</label>
                                    <input class="form-radio-input" type="radio" name="device" id="flexRadioDefault_s" value="samsung" @if($cell_phones->cpb_device == "samsung") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_s">Samsung</label>
                                    <input class="form-radio-input" type="radio" name="device" id="flexRadioDefault_o" value="other" @if($cell_phones->cpb_device == "other") checked @else @endif>
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <input type="text" name="devicemodel" class="form-control" placeholder="Ex) Iphone 13, Iphone 13 mini, Galaxy S22, ETC" aria-label="Device Model" value="{{ $cell_phones->cpb_devicemodel }}" id="devicemodel">
                                    @error('devicemodel') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <h6>OS Version <span style="color:red">*</span></h6>
                                    <input type="text" name="osversion" class="form-control" placeholder="Ex) Android Version 13, IOS version 16.5" aria-label="Os Version" value="{{ $cell_phones->cpb_osversion }}" id="osversion">
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <input type="text" name="imeinumber" class="form-control" placeholder="IMEI Number" aria-label="IMEI Number" value="{{ $cell_phones->cpb_imeinumber }}" id="imeinumber">
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="plan" id="flexRadioDefault_p" value="ok" @if($cell_phones->cpb_plan == "ok") checked @else @endif>
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <input type="text" name="chooselastnumber" class="form-control" placeholder="Please choose the last four digits of your phone number." aria-label="Please choose the last four digits of your phone number." value="{{ $cell_phones->cpb_chooselastnumber }}" onKeyPress="javascript:checkInputNum();" maxlength="4" id="chooselastnumber">
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    <div id="signature">
                                    @if($cell_phones->stu_filename)
                                        <img id="signature_img" src="{{ $cell_phones->stu_base64 }}"/>
                                    @endif
                                    </div>
                                </div>
                                <div class="flex flex-col mb-3">
                                    <h6>Referral</h6>
                                    <input type="text" name="referral" class="form-control" placeholder="Please enter the referral's email address, phone number and name" aria-label="Referral" value="{{ $cell_phones->cpb_referral }}" id="referral">
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="callservice" id="flexRadioDefault_y" value="yes" @if($cell_phones->cpb_callservice == "yes") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_y">Yes</label>
                                    <input class="form-radio-input" type="radio" name="callservice" id="flexRadioDefault_n" value="no" @if($cell_phones->cpb_callservice == "no") checked @else @endif>
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="service" id="flexRadioDefault_ag" value="annual_agreement" @if($cell_phones->cpb_service == "annual_agreement") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_ag">Annual Agreement (25% discount)</label>
                                    <input class="form-radio-input" type="radio" name="service" id="flexRadioDefault_mp" value="monthly_plan" @if($cell_phones->cpb_service == "monthly_plan") checked @else @endif>
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <input class="form-radio-input" type="radio" name="connectivity" id="flexRadioDefault_4g" value="4g" @if($cell_phones->cpb_connectivity == "4g") checked @else @endif>
                                    <label class="form-radio-label" for="flexRadioDefault_4g">4G</label>
                                    <input class="form-radio-input" type="radio" name="connectivity" id="flexRadioDefault_5g" value="5g" @if($cell_phones->cpb_connectivity == "5g") checked @else @endif>
