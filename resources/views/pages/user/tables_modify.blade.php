            ...
            $('#lang_check').change(function() {
                ...
                switch(value) {
                    ...
                    case 'russian' :
                        ...
                        $('#form_submit').text("Изменить форму");
                    ...
                    case 'uzbek' :
                        ...
                        $('#form_submit').text("Shaklni o'zgartirish");
                    ...
                    case 'tagalog' :
                        ...
                        $('#form_submit').text("Baguhin ang Form");
                    ...
                    case 'vietnamese' :
                        ...
                        $('#form_submit').text("Sửa đổi biểu mẫu");
                        ...
                        <div class="table-responsive p-0" style="width:92%; margin:auto; margin-top:30px;">
                            ...
                            @csrf
                                ...
                                <div class="form-radio form-check-info text-start">
                                    ...
                                    <p id="plan_notice_lang">Please note that devices purchased from the United States may not be compatible with our 5G plan.</p>
